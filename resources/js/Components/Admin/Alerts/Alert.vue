...
<template>
    ...
    >
        <div
            class="mr-5 flex h-9 w-full max-w-[36px] items-center justify-center rounded-lg"
            :class="{ 'bg-[#F87171]' : type === 'error',
               'bg-warning' : type === 'warning',
               'bg-[#34D399]' : type === 'success'
     }"
        >
            <svg v-if="type === 'error'"
                 width="13"
        ...
        <div class="w-100">
            ...
            <ul>
                <li class="leading-relaxed "
                    :class="{ 'text-[#CD5D5D]' : type === 'error',
               'text-[#D0915C]' : type === 'warning',
               'text-body' : type === 'success'
     }"
                >
                    {{ description }}
                </li>
